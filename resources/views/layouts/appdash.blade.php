                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="{{route('products')}}" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table text-white p-2"></i> <span class="ms-1 d-none d-sm-inline text-white">المنيو</span></a>
                    </li>
                  
                    <li>
                        <a href="{{route('showdet')}}"  class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-grid text-white"></i> <span class="ms-1 d-none d-sm-inline text-white">تفاصيل المنيو</span> </a>
                         
                               </li>
                    <li>
                        <a href="{{route('dashboard.costumers')}}" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people text-white"></i> <span class="ms-1 d-none d-sm-inline text-white">حجز العميل</span> </a>
                    </li>
                    <li>
                        <a href="{{route('showorders')}}" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people text-white"></i> <span class="ms-1 d-none d-sm-inline text-white">الطلبات </span> </a>
                    </li>
                </ul>
                <hr>
